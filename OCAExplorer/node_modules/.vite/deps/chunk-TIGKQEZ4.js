  ...
  return (0, import_jsx_runtime6.jsx)(
    Portal_default,
    {
      ...
      children: (0, import_jsx_runtime7.jsxs)(Root, {
        ...rootProps,
        children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime6.jsx)(BackdropComponent, {
          ...backdropProps
...
var Badge = React9.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime12.jsxs)(Root, {
    ...rootProps,
    children: [children, (0, import_jsx_runtime11.jsx)(BadgeComponent, {
      ...badgeProps,
...
function useButton(parameters = {}) {
  ...
  const [hostElementName, setHostElementName] = React10.useState("");
  ...
  const updateHostElementName = React10.useCallback((instance) => {
...
var FormControl = React13.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime14.jsx)(Root, {
      ...rootProps
    })
  });
});
...
var Input = React16.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime16.jsxs)(Root, {
    ...rootProps,
    children: [startAdornment, (0, import_jsx_runtime15.jsx)(InputComponent, {
      ...inputProps
    }), endAdornment]
  });
});
...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React19.useRef(initialState);
  React19.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React19.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const reducerWithControlledState = React19.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    return reducer(controlledState, action);
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React19.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React19.useCallback((action) => {
    dispatch({
      ...action,
...
function useList(params) {
  ...
  const actionContext = React22.useMemo(() => ({
...
function useCompoundParent() {
  ...
  const registerItem = React26.useCallback(function registerItem2(id, item, missingKeyGenerator) {
...
function useMenu(parameters = {}) {
  ...
  const stateChangeHandler = React27.useCallback((event, field, fieldValue, reason, state) => {
    if (field === "open") {
...
var Popper = React29.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime18.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime18.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Menu = React30.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime19.jsx)(Root, {
    ...rootProps,
    children: (0, import_jsx_runtime19.jsx)(Listbox, {
      ...listboxProps,
...
function useCompoundItem(id, itemMetadata, missingKeyGenerator) {
  ...
  const [registeredId, setRegisteredId] = React31.useState(id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
var MenuItem = React33.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var OptionGroup = React34.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {},
...
function useOption(params) {
  ...
  const selectOption = React35.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
var Option = React36.forwardRef(function Option2(props, forwardedRef) {
...
var Option_default = React36.memo(Option);
...
function useSelect(props) {
  ...
  const getOptionMetadata = React37.useCallback((optionValue) => options.get(optionValue), [options]);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime25.jsx)(React39.Fragment, {
...
var Select = React39.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(React39.Fragment, {
    ...
    }), buttonDefined && (0, import_jsx_runtime25.jsx)(PopperComponent, {
      ...popperProps,
...
var Slider = React41.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime27.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime28.jsxs)(React41.Fragment, {
      ...
      const style = axisProps2[axis].offset(percent);
      return (0, import_jsx_runtime28.jsxs)(Thumb, {
        "data-index": index,
        ...thumbProps,
...
var Snackbar = React43.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsx)(ClickAwayListener_default, {
    ...clickAwayListenerProps,
    children: (0, import_jsx_runtime29.jsx)(Root, {
      ...rootProps,
      children
    })
  });
...
var Switch = React45.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(Root, {
    ...rootProps,
    children: [(0, import_jsx_runtime30.jsx)(Track, {
      ...trackProps
    }), (0, import_jsx_runtime30.jsx)(Thumb, {
      ...thumbProps
    }), (0, import_jsx_runtime30.jsx)(Input3, {
      ...inputProps
    })]
  });
});
...
var TablePaginationActions = React46.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsxs)(Root, {
    ...rootProps,
...
var TablePagination = React47.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsx)(Root, {
    ...rootProps,
    children: (0, import_jsx_runtime35.jsxs)(Toolbar, {
      ...toolbarProps,
      children: [(0, import_jsx_runtime34.jsx)(Spacer, {
        ...spacerProps
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime34.jsx)(SelectLabel, {
        ...selectLabelProps,
        children: labelRowsPerPage
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime34.jsx)(Select3, {
        ...selectProps,
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react.createElement)(MenuItem3, {
          ...menuItemProps,
          key: typeof rowsPerPageOption !== "number" && rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption,
          value: typeof rowsPerPageOption !== "number" && rowsPerPageOption.value ? rowsPerPageOption.value : rowsPerPageOption
        }, typeof rowsPerPageOption !== "number" && rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption))
      }), (0, import_jsx_runtime34.jsx)(DisplayedRows, {
        ...displayedRowsProps,
      ...
      }), (0, import_jsx_runtime34.jsx)(Actions, {
        ...actionsProps
      })]
    })
  });
...
var Tabs = React51.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsx)(TabsRoot, {
    ...tabsRootProps,
...
var TabPanel = React52.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    value,
  ...
  return (0, import_jsx_runtime38.jsx)(TabPanelRoot, {
    ...tabPanelRootProps,
...
var TabsList = React55.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
  ...
  return (0, import_jsx_runtime40.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime40.jsx)(TabsListRoot, {
      ...tabsListRootProps,
      children
    })
  });
...
var Tab = React57.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
  ...
  return (0, import_jsx_runtime41.jsx)(TabRoot, {
    ...tabRootProps,
    children
  });
});
...
var SvgIcon = React58.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime43.jsxs)(SvgIconRoot, {
    as: component,
    ...
    ...other,
    ownerState,
    children: [children, titleAccess ? (0, import_jsx_runtime42.jsx)("title", {
...
true ? SvgIcon.propTypes = {
   ...
   * @default 'inherit'
   */
  color: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["inherit", "action", "disabled", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types25.default.string]),
  /**
   ...
   * @default 'medium'
   */
  fontSize: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["inherit", "large", "medium", "small"]), import_prop_types25.default.string]),
  /**
   ...
   * @default false
   */
  inheritViewBox: import_prop_types25.default.bool,
  /**
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime44.jsx)(SvgIcon_default, {
  ...
  return React59.memo(React59.forwardRef(Component));
}
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TIGKQEZ4.js.map
