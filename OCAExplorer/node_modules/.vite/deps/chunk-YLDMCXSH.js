...
function createGrid(options = {}) {
  ...
  const OverflowContext = React16.createContext(void 0);
  ...
  const Grid2 = React16.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React16.useContext(OverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime3.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
      ...
      children: React16.Children.map(children, (child) => {
        if (React16.isValidElement(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime3.jsx)(OverflowContext.Provider, {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React25.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsxs)(React25.Fragment, {
  ...
  const getInitColorSchemeScript2 = (params) => getInitColorSchemeScript({
    attribute: defaultAttribute,
    colorSchemeStorageKey: defaultColorSchemeStorageKey,
    defaultMode: designSystemMode,
    defaultLightColorScheme,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YLDMCXSH.js.map
